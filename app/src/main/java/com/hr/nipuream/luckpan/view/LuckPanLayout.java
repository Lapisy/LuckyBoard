...
public class LuckPanLayout extends View {
    ...
    public LuckPanLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        backgroundPaint.setColor(context.getResources().getColor(R.color.dark_red_color));
        whitePaint.setColor(context.getResources().getColor(R.color.white_color));
        yellowPaint.setColor(context.getResources().getColor(R.color.dark_yellow_color));
    }
